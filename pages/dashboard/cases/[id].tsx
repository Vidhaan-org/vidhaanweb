        ...
        <div className="flex flex-col px-8 py-6">
          ...
          <div className="rounded-md h-max flex flex-col overflow-hidden bg-gray-200 border border-gray-400">
            ...
            <div className="px-8 py-4 h-max">
              ...
              Necessitatibus delectus atque deserunt quos sed nihil, repellat
              odio ea omnis expedita voluptatibus nemo sapiente sint dolorum
              nulla exercitationem quisquam nam impedit fugit, quae vitae nobis.
              Numquam harum fugit laboriosam! Iure sequi vero repellendus
              eveniet. Eum quam, pariatur sequi ullam ipsum explicabo similique
              et nostrum, consectetur, aliquam ea quis illum? Exercitationem
              doloremque doloribus assumenda obcaecati tenetur vitae nostrum,
              reiciendis aperiam? Magnam iure eum laborum officia corporis ex!
              Aut sed sit possimus voluptatum accusamus rem, impedit libero quo
              voluptate placeat, sapiente ut, quaerat similique alias aspernatur
              sequi. Ex a illum beatae? Lorem ipsum dolor sit amet consectetur
              adipisicing elit. Nihil magnam beatae quos consequuntur excepturi,
              doloribus recusandae repudiandae doloremque voluptatem harum
              voluptatum commodi, reiciendis odit delectus voluptas placeat,
              enim consequatur. Repudiandae. Sapiente nesciunt asperiores quia
              corrupti ea saepe. Nemo assumenda harum quo. Repellat doloribus
              quasi necessitatibus voluptatum, ipsum obcaecati vero esse minima
              aliquam optio quia unde numquam, nostrum ex id excepturi.
            </div>
          </div>
